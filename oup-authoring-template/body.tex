...
pipeline (Typer CLI, OmegaConf YAML configuration, Polars throughout) that
consumes the bindings directly and so doubles as a reference example for
...
provides parallel index construction. Search is parallelised with Rayon~\citep{rayon}
