...
Built on the RIsearch core bindings (\cref{subsec:pybindings}), RIOT thus serves both as a turnkey command-line tool and as a library component of bespoke off-target analyses.
