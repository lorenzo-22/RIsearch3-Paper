...
Alongside the core, we distribute \textbf{RIOT} (RIsearch siRNA Off-Target pipeline), a complete reimplementation of the siRNA off-target pipeline of \citet{alkan2017risearch2} (\cref{fig:summary}).
