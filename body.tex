...
Its suffix array is also built in parallel across cores, about $2\times$ faster than RIsearch2's single-threaded libdivsufsort construction on the hg38 genome (Supplementary Figure~S6).
